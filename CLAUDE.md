...
- Navegación por tabs: `mostrarTab('<Nombre>')`. Tabs: Home, Dashboard, Vencimientos, CajaGeneral, EfectivoPesos, EfectivoUSD, CuentasBancarias, Ventas, Alquileres, Servicios, IngGeneral, ResumenIngresos, Facturas, Proveedores, Presupuestos, Pagos, Egresos, Tesoreria, Documentos, Reportes, PlanTrabajo, Config.
